...
src_prepare() {
	...
	if ! use system-vpx; then
		...
		keeplibs+=( third_party/libvpx/source/libvpx/vpx_util/vpx_thread.h )
		keeplibs+=( third_party/libvpx/source/libvpx/vp8 )
		keeplibs+=( third_party/libvpx/source/libvpx/vp9 )
		keeplibs+=( third_party/libvpx/source/libvpx/vpx )
	fi
	if ! use system-aom; then
		...
		keeplibs+=( third_party/libaom/source/aom_util/aom_thread.h )
		keeplibs+=( third_party/libaom/source/libaom/av1/ratectrl_rtc.h )
	fi
